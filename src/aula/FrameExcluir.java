...
public class FrameExcluir extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        jLabel4.setText(infos.getTitulo());
        jLabel7.setText(Double.toString(infos.getPreco()));

        //jTextField2.setText(amigos.getTitulo());
        //jTextField3.setText(Double.toString(amigos.getPreco()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameExcluir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
